...
"""
Phase 1 extractive benchmark: TF-IDF, TextRank, and PhoBERT-extractive on a fixed
VietNews validation subset (shared protocol). Writes engine_compare_* and per-engine CSV/JSON/MD.
"""
...
# Canonical path string embedded in JSON reports (artifact provenance).
SCRIPT_REPORT_PATH = "scripts/benchmark_extractive_engines.py"
...
def run_benchmark() -> tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame, dict]:
    ...
    report = {
        ...
        "notebook_or_script": SCRIPT_REPORT_PATH,
